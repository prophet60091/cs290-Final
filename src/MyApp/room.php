...
-->
<div class="row">
    <div class="large-8 large-offset-1 columns small-12 roomTitle ">Pusher | <span>Share youTube Videos with Friends</span></div>
</div>
<div class="row">
...
//This object constructor will hold all of the mesages
...
window.onload = function(){
    ...
    //welcome the user in the chat window
    var user = localStorage.getItem('userName');
    var chat = document.createElement("div");
    var cwind = document.getElementById("messages");

    cwind.appendChild(chat);
    cwind.lastElementChild.innerHTML = 'Welcome, '+ user + ' Type below to chat.';

    //alert others that they are here
    sendMsg(user + 'joined the room');

    //display something in the blank iframe;
